    ...
    <div className="space-y-8">
      ...
      <div className="grid gap-4 md:grid-cols-4">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold text-zinc-600">{stats.submitted}</div>
          </CardContent>
        </Card>
      </div>
          ...
          {isLoading ? (
            ...
            <div className="space-y-4">
              {filtered.map((application: Application) => {
                ...
                const statusColor = applicationStatusColors[application.status] || 'bg-amber-50 text-amber-700';
